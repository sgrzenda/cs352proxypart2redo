...
We have fixed our part 2 code and tested it so that we now know that multiple connections will work. We tested it on up to 4 taps, 2 per machine. We can ping from one machine to all other machines. Our code for the last submission did not work with ping and multiple connections.
